...
const availableLanguages =
  require("./static/translations/tsconfig.json").languages;
...
module.exports = (env, argv) => {
  ...
  return {
    ...
    snapshot: {
      managedPaths: [
        new RegExp(
          String.raw`(.*(\\|\/)node_modules(\\|\/)(?!${qwc2ModName}))`,
        ),
      ],
    },
    plugins: [
      ...
      new webpack.NormalModuleReplacementPlugin(
        /openlayers$/,
        path.join(__dirname, "node_modules", qwc2ModName, "libs", "openlayers"),
      ),
        ...
        },
        {
          ...
          use: {
            ...
            options: {
              babelrcRoots: [
                ".",
                path.resolve(__dirname, "node_modules", qwc2ModName),
              ],
            },
          },
        },
